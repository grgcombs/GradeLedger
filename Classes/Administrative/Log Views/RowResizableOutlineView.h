...
/** An NSOutlineView subclass which allows for resizable rows. At the moment the implementation is FAR from optimized, however it seems to run reasonably well with moderately sized tables. Right now, the table rows will resize itself to fit the contents of the text cells. In the future, it may be possible to programatically turn this feature on and off and use setHeightOfRow to programatically change the heights. */
